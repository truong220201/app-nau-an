 ...
 function ThemMon({route,navigation}) {
    ...
    return (
        <View style={styles.container}>
            <Image  style={{width:200,height:250, marginTop:40 }}source = {{uri:'https://banner2.cleanpng.com/20180623/iqh/kisspng-computer-icons-avatar-social-media-blog-font-aweso-avatar-icon-5b2e99c40ce333.6524068515297806760528.jpg'}}></Image>
            ...
            <View style={styles.footer}>
              <TouchableOpacity  style={styles.c4} onPress={()=>navigation.navigate('lTab')}>
              ...
              <TouchableOpacity  style={styles.c4} onPress={()=>navigation.navigate('themmon')}>
                  <FontAwesome5 style = {{}} name="heart" size={20} color="orange"
                  />
              </TouchableOpacity>
